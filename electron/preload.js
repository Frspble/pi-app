...
contextBridge.exposeInMainWorld("piDesktop", {
  ...
  readClipboardText: () => ipcRenderer.invoke("piDesktop:readClipboardText"),
  writeClipboardText: (text) => ipcRenderer.invoke("piDesktop:writeClipboardText", text),
  revealPath: (targetPath) => ipcRenderer.invoke("piDesktop:revealPath", targetPath),
