...
const THINKING_LEVEL_DESC_KEY: Record<typeof THINKING_LEVELS[number], "chat.thinking.auto" | "chat.thinking.off" | "chat.thinking.minimal" | "chat.thinking.low" | "chat.thinking.medium" | "chat.thinking.high" | "chat.thinking.xhigh"> = {
  auto: "chat.thinking.auto",
                ...
                {thinkingDropdownOpen && (
                  <div style={{
                    ...
                    {THINKING_LEVELS.filter((lvl) => {
                      ...
                      const desc = t(THINKING_LEVEL_DESC_KEY[lvl]);
                ...
                {toolDropdownOpen && (
                  <div style={{
                    ...
                    {TOOL_PRESETS.map((lvl) => {
                      ...
                      const desc = lvl === "off" ? t("chat.tools.off") : lvl === "default" ? t("chat.tools.default") : t("chat.tools.full");
                      return (
                        <button
                          key={lvl}
            ...
            {!isStreaming && onCompact && (
              <div style={{ position: "relative" }}>
                ...
                <button
                  ...
                  title={isCompacting ? t("chat.stopCompactTitle") : t("chat.compactTitle")}
                >
                  {isCompacting ? (
