...
export const translations = {
  en: {
    ...
    "contextMenu.revealInFinder": "Show in Finder",
    "contextMenu.revealInExplorer": "Show in File Explorer",
    ...
    "settings.updatesHelp": "Check GitHub for Pi App releases.",
    ...
    "updates.app": "Pi App",
    "updates.appHelp": "App updates are downloaded from GitHub Releases.",
    ...
    "updates.checking": "Checking GitHub for the latest Pi App release...",
    "updates.available": "A new Pi App release is available.",
    "updates.upToDate": "Pi App is up to date.",
    "updates.failed": "Failed to check Pi App updates.",
    "updates.unavailable": "App update checks are available inside the desktop app.",
    "updates.check": "Check Updates",
    "updates.openDownload": "Open Download Page",
    "updates.hasUpdate": "Update available",
    "updates.current": "Current",
    "about.description": "Pi App is packaged from the Pi Web project, with its core capabilities powered by Pi Agent.",
    ...
    "app.resizeFilePanel": "Resize file panel",
    "sidebar.new": "New",
  ...
  zh: {
    ...
    "settings.updates": "更新",
    "settings.updatesHelp": "从 GitHub 检查 Pi App 发布版本。",
    "settings.about": "关于",
    ...
    "updates.title": "更新",
    "updates.app": "Pi App",
    "updates.appHelp": "App 更新需要从 GitHub Releases 下载。",
    "updates.currentVersion": "当前版本",
    "updates.latestVersion": "最新版本",
    "updates.release": "Release",
    "updates.published": "发布时间",
    "updates.notChecked": "尚未检查",
    "updates.checking": "正在从 GitHub 检查 Pi App 最新版本...",
    "updates.available": "发现新的 Pi App 版本。",
    "updates.upToDate": "Pi App 已是最新版本。",
    "updates.failed": "检查 Pi App 更新失败。",
    "updates.unavailable": "App 更新检查只在桌面 App 中可用。",
    "updates.check": "检查更新",
    "updates.openDownload": "打开下载页面",
    "updates.hasUpdate": "可更新",
    "updates.current": "当前版本",
    "about.description": "Pi App 是基于 Pi Web 项目打包而来的桌面客户端，核心能力基于 Pi Agent。",
    "about.version": "版本",
    "about.repository": "仓库",
    "about.github": "GitHub",
    "about.releases": "Releases",
